...
set SPIRV_CROSS=vulkan-sdk-1.4.312.0
...
call :downloadfile "zlib-ng-%ZLIBNG%.zip" "https://github.com/zlib-ng/zlib-ng/archive/refs/tags/%ZLIBNG%.zip" 8a247f57d1e3e6f6d11413b12a6f28a9d388de110adc0ec608d893180ed7097b || goto error
